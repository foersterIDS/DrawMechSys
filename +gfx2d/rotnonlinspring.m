classdef rotnonlinspring < gfx2d.DrawMechSysObject
    ...
    methods
        function obj = rotnonlinspring(X,Y,b,lmin,center,varargin)
            %% Init:
            stdinp = 5;
            co = [0,0,0];
            obj.n = 4;
            ...
            xsrMid = [xsrMid,l-obj.lmin/2,NaN,...
                linspace(l-obj.lmin/2,obj.lmin/2,obj.Nu),NaN...
                linspace(obj.lmin/2,xp1,obj.Nu),NaN,...
                linspace(obj.lmin/2,xp2,obj.Nu)];
            ysrMid = [ysrMid,0,NaN,...
                linspace(+obj.b/2,-obj.b/2,obj.Nu),NaN,...
                linspace(-obj.b/2,yp1,obj.Nu),NaN,...
                linspace(-obj.b/2,yp2,obj.Nu)];
            xsr2 = [l-obj.lmin/2,l];
            ysr2 = [0,0];
            % Transformation:
